	...
	var getDataModule =  {
		...
		bindEvents: function() {
			...
			this.$addBtnEl.on('click', function(e) {
				...
				_self.$busListEl.append('<div class="alert alert-primary busItem"><i class="material-icons" style="vertical-align: middle;">directions_bus</i>'+bus+'<i class="material-icons" style="float: right; vertical-align: middle;">close</i></div>');
